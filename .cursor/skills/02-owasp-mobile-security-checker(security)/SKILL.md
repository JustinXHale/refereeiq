...
Four Python scanners cover the most automatable risk categories. Replace `<skill-dir>` with this repo's skill folder or your Cursor skills directory (e.g. `.cursor/skills/02-owasp-mobile-security-checker(security)` in this project):
